...
const generateNames = () => {
    ...
    const suggestion1 = namesOne[randomNumArr[0]] + namesTwo[randomNumArr[1]];
    const suggestion2 = namesOne[randomNumArr[1]] + namesTwo[randomNumArr[3]];
    const suggestion3 = namesOne[randomNumArr[2]] + namesTwo[randomNumArr[0]];
